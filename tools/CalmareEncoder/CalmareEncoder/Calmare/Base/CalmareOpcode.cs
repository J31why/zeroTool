...
/*
		ED7MenuNew menu[0]
		if flag[1925]:
			ED7MenuAdd menu[0] "蓝色警官　　　　已购买"
			ED7MenuSetDisabled menu[0] 0
		else:
			ED7MenuAdd menu[0] "蓝色警官　　　　1000米拉"
		if flag[1926]:
			ED7MenuAdd menu[0] "和平绿　　　　　已购买"
			ED7MenuSetDisabled menu[0] 1
		else:
			ED7MenuAdd menu[0] "和平绿　　　　　1000米拉"
		if flag[1927]:
			ED7MenuAdd menu[0] "黑猫　　　　　　已购买"
			ED7MenuSetDisabled menu[0] 2
		else:
			ED7MenuAdd menu[0] "黑猫　　　　　　1000米拉"
		if flag[1928]:
			ED7MenuAdd menu[0] "危险橙　　　　　已购买"
			ED7MenuSetDisabled menu[0] 3
		else:
			ED7MenuAdd menu[0] "危险橙　　　　　1000米拉"
		ED7MenuAdd menu[0] "放弃"
