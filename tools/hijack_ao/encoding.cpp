...
namespace encoding {
    ...
    size_t check_sjis_sequence(const char* ptr, size_t remaining_len) {
        ...
        // SJIS �������ֽ� 0x81~0x9F �� 0xE0~0xFC���ڶ��ֽ� 0x40~0xFC���ų�0x7F��
    ...
    size_t check_gbk_sequence(const char* ptr, size_t remaining_len) {
        ...
        uint8_t first = *ptr, second = ptr[1];
        // GBK ����
        // ���ֽڣ�0x81~0xFE������ GB2312 �� 0xA1~0xF7����չ�� 0x81~0xFE��
        // �ڶ��ֽڣ�0x40~0x7E �� 0x80~0xFE�����η�Χ���� 0x7F ���ƣ�
    ...
    int64_t check_encoding(const char* data) {
        ...
        size_t count_ascii = 0;       // �ɴ�ӡ ASCII �ַ���
        size_t count_utf8 = 0;        // �Ϸ� UTF-8 ���ֽ�������
        size_t count_sjis = 0;        // �Ϸ� SJIS ���ֽ�������
        size_t count_gbk = 0;         // �Ϸ� GBK ���ֽ�������
        size_t count_utf8_special = 0;// �ض� UTF-8 ���У�0xE3 ��ͷ��������أ�
        const char* ptr = data;
