...
public partial class AsCodec
{
    private readonly Dictionary<byte, (AsOpcodes code, Func<AsCodec, ParameterType[]> Params)> _opFuncs = new()
    {
        ...
        { 0x33, OP_33.As(b, b) },
        { 0x34, OP_34.As() },
        { 0x35, KeepAngle.As(b, i, i, i, i) },
        { 0x36, OP_36.As(s) },
        //
        { 0x39, SetAngle.As(s, s, s, i) },
        { 0x3A, TiltAngle.As(s, i) },
        { 0x3B, RotationAngleHorz.As(i, i) },
        { 0x3C, OP_3C.As(s, i) },
        { 0x3D, ShakeScreen.As(i, i, i, i) },
        { 0x3E, OP_3E.As(i, i) },
        { 0x3F, OP_3F.As(b) },
        { 0x40, OP_40.As(b) },
        { 0x41, LockAngle.As(b) },
        { 0x42, OP_42.As(b, i, b) },
        { 0x43, SetBkColor.As(b, i, i) },
        { 0x44, ZoomAngle.As(b, i, i) },
        { 0x45, OP_45.As(b, i) },
        { 0x46, OP_46.As(b, i, i) },
        { 0x47, OP_47.As(b) },
        { 0x48, OP_48.As(b, i) },
        ...
        { 0xA8, DamageVoice.As(b, s) },
        { 0xA9, OP_A9.As(b, b, i) },
        { 0xAA, OP_AA.As(i, i) },
        //
        { 0xAC, OP_AC.As(b, b, i, i, b) },
        { 0xAE, OP_AE.As(b, b, b) },
