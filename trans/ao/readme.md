...
详情请参阅：[MorePortraitsInAzure](https://github.com/shinkiseki/MorePortraitsInAzure)
...
**兼容补丁**：
修改游戏主程序后的高兼容模式，汉化失败或steamdeck玩家可使用，主程序修改版本为`v1.2.5`。  
1. 正常安装汉化补丁。
2. 备份`ao.exe`原文件。
...
修复文本：异体词修正。  
修复脚本：脚本转换错误导致游戏乱码且崩溃，现已修复（`t4030`）。  
